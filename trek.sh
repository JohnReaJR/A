...
sysctl -w net.ipv4.neigh.default.base_reachable_time_ms=300000
...
echo "net.ipv4.neigh.default.gc_thresh3=1024" >> /etc/sysctl.conf
echo "net.ipv4.neigh.default.gc_thresh2=512" >> /etc/sysctl.conf
echo "net.ipv4.neigh.default.gc_thresh1=128" >> /etc/sysctl.conf
echo "net.ipv4.neigh.default.gc_interval=30" >> /etc/sysctl.conf
echo "net.ipv4.neigh.default.gc_stale_time=60" >> /etc/sysctl.conf
